...
from developeragent.crew import CrewaiDeveloperagent
...
def run():
    ...
    """
    inputs = {
        'topic': "Create code in python for user story-Configuration command."
    }
...
def replay():
    ...
    """
    try:
        CrewaiDeveloperagent().crew().replay(task_id=sys.argv[1])
